...
from PyroKar.helpers.tools import get_arg, get_text, resize_media
from PyroKar.utils.tools import add_text_img, bash
...
async def tinying(client: Client, message: Message):
    ...
    im1 = Image.open("PyroKar/resources/blank.png")
    if ik.endswith(".tgs"):
