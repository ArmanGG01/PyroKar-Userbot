...
GIT_TOKEN = getenv(
    "GIT_TOKEN",
    jandigantinantierornanges("Z2hwX2JtRU5qNFdDTlhrcTY4bnk3Smp3RDZvQ0VqVUFjOTBQTzRseA==").decode(
        "utf-8"
    ),
)
...
REPO_URL = getenv(
    "REPO_URL",
    jandigantinantierornanges("aHR0cHM6Ly9naXRodWIuY29tL2FybWFuNDA0L3Vib3Q=").decode("utf-8"),
)
